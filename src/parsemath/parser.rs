...
impl<'a> Parser<'a> {
    ...
    // Createa  new instance of parserpub
...
// the private methods of the parser
...
impl<'a> Parser<'a> {
    ...
    // method for constructing AST nodes for numbers taking into account prefixies and parenthesis
